...
class AuthController
{
    ...
    public function login($request)
    {
        ...
        if ($findUser) {
            ...
            return $this->sendResponse(message: 'نام کاربری شما یا رمز عبور شما صحیح نیست', error:true, status: HTTP_Unauthorized);
        }
    }
    ...
    public function register($request)
    {
        ...
        $newUser = $this->queryBuilder->table('users')->insert([
